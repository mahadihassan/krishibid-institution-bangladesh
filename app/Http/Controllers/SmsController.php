...
class SmsController extends Controller
{
    ...
    private $SMS_SENDER = "kibreservnonbrand";
    private $RESPONSE_TYPE = 'json';
    private $SMS_USERNAME = 'kibreserv';
    private $SMS_PASSWORD = 'HuoHA1.84pj';
...
//        $this->initiateSmsGuzzle($phone_number, $message);
    ...
    public function initiateSmsActivation($phone_number, $message){
        ...
        $url = "http://sms.g8ict.com/api/SendSMS?";
    ...
    public function initiateSmsGuzzle($phone_number, $message)
    {
        ...
        $response = $client->post('http://sms.g8ict.com/api/SendSMS?', [
            'verify'    =>  false,
            'form_params' => [
                'username' => $this->SMS_USERNAME,
                'password' => $this->SMS_PASSWORD,
